// ARCHIVED — Not served. Replaced by /ls-connect/privacy-policy (March 2026).
          ...
          <section id="whatsapp" className="scroll-mt-8">
            ...
            <div className="mt-8 bg-[#1a1a1a] text-[#f9f7f4] rounded-2xl p-8 space-y-5 text-sm leading-relaxed">
              ...
              <DetailRow label="What we send &amp; frequency">
                Transactional messages (booking confirmations, invoices ÔÇö usually 1ÔÇô3 per
                transaction), appointment reminders (1ÔÇô2 per event), and customer support messages
              ...
              <DetailRow label="Opt-out">
                ...
                . Opt-outs processed within 24ÔÇô72 hours.
              </DetailRow>
...
/* ÔöÇÔöÇÔöÇ Reusable primitives ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
