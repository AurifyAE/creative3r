...
export default function MuneebProfilePage() {
                ...
                <div className="relative px-6 sm:px-8 pt-10 pb-8">
                        ...
                        <div className="relative mb-5">
                            ...
                            <div className="relative w-[140px] h-[140px] rounded-full bg-gradient-to-br from-[#F9844A] to-[#F9C74F] p-[3px]">
                                <div className="relative h-full w-full overflow-hidden rounded-full bg-[#1F1E1E]">
                                    <Image src={PROFILE.avatar} alt={PROFILE.name} fill sizes="140px" loading='eager' className="object-cover" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-3 gap-x-3 gap-y-6">
                        {LINKS.map(({ label, href, icon: Icon }, index) => (
                            ...
                            >
                                <span className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.1] transition-all duration-300 group-hover:border-[#F9844A]/50 group-hover:bg-[#F9844A]/10">
                                    {typeof Icon === 'string' ? (
