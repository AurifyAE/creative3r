...
const PROFILE = {
    name: 'Sabah Shabnam',
    title: 'Creative Head',
    phoneDisplay: '+971 50 426 8972',
    phoneHref: 'tel:+971504268972',
    whatsappHref: 'https://wa.me/971504268972',
    email: 'sabah@creative3r.com',
};
...
export default function SabahProfilePage() {
                        ...
                        <div className="relative mb-5">
                            ...
                            <div className="relative w-[140px] h-[140px] rounded-full bg-gradient-to-br from-[#F9844A] to-[#F9C74F] p-[3px]">
                                <div className="relative h-full w-full overflow-hidden rounded-full bg-[#1F1E1E]">
                                    <Image src="/assets/images/profiles/sabaah.webp" alt={PROFILE.name} fill sizes="100px" loading='eager' className="object-cover" />
                                </div>
                            </div>
                        </div>
